...
class Test(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = _("Test")  # TODO: make this more human readable by adding spaces
...
class TestWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setParameterNode(self, inputParameterNode: TestParameterNode | None) -> None:
        """
...
class TestLogic(ScriptedLoadableModuleLogic):
    ...
    def getParameterNode(self):
        return TestParameterNode(super().getParameterNode())
